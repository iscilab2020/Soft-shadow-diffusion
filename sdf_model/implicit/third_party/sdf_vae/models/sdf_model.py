...
from implicit.third_party.sdf_vae.models.archs.encoders.conv_pointnet import ConvPointnet
from implicit.third_party.sdf_vae.models.archs.sdf_decoder import SdfDecoder
...
class SdfModel(pl.LightningModule):
    ...
    def __init__(self, specs):
        ...
        self.plane_resolution = model_specs.get("plane_resolution", 64)
